...
# v2: Multi-GPU finetune with Accelerate (8x H200) - Adapter only
...
# Usage:
#   New:    qsub -v MODEL_ID=models/v2/LlamaForSpeechLM-ja-step20000 scripts/v2/finetune_adapter_ja_8gpu.sh
#   Resume: qsub -v RESUME_FROM=models/v2/LlamaForSpeechLM-ja-Instruct-step1000 scripts/v2/finetune_adapter_ja_8gpu.sh
#   Weights: qsub -v MODEL_ID=...,DATASET_WEIGHTS="3,1,4,1,1,1" scripts/v2/finetune_adapter_ja_8gpu.sh

echo "Mode: Adapter only - 8 GPU (v2)"

ARGS="--max-steps 1000000000 --batch-size 2 --grad-accumulation 8 --warmup-steps 100 --val-check-interval 1000 --lr 1e-4"
