...
# Qwen2-Audio-Encoder + LLM-JP-4-8B + Full decoder + MultiTaskSFT
...
echo "=== Qwen2-Audio-Encoder + LLM-JP-4-8B Full Decoder SFT ==="
...
finetune(
    ...
    model_dir='models/v2/LlamaForSpeechLM-Qwen2Audio-Full-${TIMESTAMP}'
)
"
