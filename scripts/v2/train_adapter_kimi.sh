...
# Kimi-Audio-Whisper-Encoder + LLM-JP-4-8B + Adapter only
...
echo "=== Kimi-Audio-Whisper-Encoder Adapter Training ==="
echo "Encoder: Atotti/Kimi-Audio-Whisper-Encoder (encoder_type=whisper)"
...
finetune(
    encoder_id='Atotti/Kimi-Audio-Whisper-Encoder',
    ...
    model_dir='models/v2/LlamaForSpeechLM-Kimi-Adapter-${TIMESTAMP}'
)
"
